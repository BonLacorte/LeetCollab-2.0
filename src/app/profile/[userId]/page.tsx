                                    ...
                                    <div className='flex flex-col w-full bg-white rounded-xl p-6 gap-4'>
                                        <div className='flex flex-row justify-around gap-2'>
                                            <div className="space-y-2 text-center">
                                                <div className="text-3xl font-bold">{totalSolved || 0}</div>
                                                <p className="text-sm text-gray-500">Problems Solved</p>
                                            </div>
                                            <div className="space-y-2 text-center">
                                                <div className="text-3xl font-bold">{userRankAndAcceptanceRate?.userRank || 0}</div>
                                                <p className="text-sm text-gray-500">Rank</p>
                                            </div>
                                            <div className="space-y-2 text-center">
                                                <div className="text-3xl font-bold">{userRankAndAcceptanceRate?.userAcceptanceRate.toFixed(2) || "0.00"}%</div>
